<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif {{ \App\Models\LAConfigs::getByKey('sitename') }} </title>
    ...
    -->
    <link href="{{ asset('la-assets/css/skins/'. \App\Models\LAConfigs::getByKey('skin') .'.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
